...
public static class Constants
{
    ...
    public static int range = 4;        // 등장하게 할 block 타입 갯수 (현재  max 7)
    ...
    public static int x7 = 160;
    public static int y7 = 1568;
    public static int gap7 = 127;
    public static float blockSize7 = 0.68f;


    public enum BlockType { Red, Pink, Blue, Green, Yellow, Purple, Orange, LOCK, Random};
